...
\section{Unsupervised Learning}
  ...
  \begin{figure}[h]
    ...
    \begin{subfigure}[t]{0.19\linewidth}
      \includegraphics[width=1\linewidth]{./lab3/PCA/single_three/original.png}
      \caption{}
      \label{fig:perfect_fit}
    \end{subfigure}
    \begin{subfigure}[t]{0.19\linewidth}
      \includegraphics[width=1\linewidth]{./lab3/PCA/single_three/PC1.png}
      \caption{}
      \label{fig:overfit}
    \end{subfigure}
    \begin{subfigure}[t]{0.19\linewidth}
      \includegraphics[width=1\linewidth]{./lab3/PCA/single_three/PC2.png}
      \caption{}
      \label{fig:underfit}
    \end{subfigure}
    \begin{subfigure}[t]{0.19\linewidth}
      \includegraphics[width=1\linewidth]{./lab3/PCA/single_three/PC3.png}
      \caption{}
      \label{fig:underfit}
    \end{subfigure}
    \begin{subfigure}[t]{0.19\linewidth}
      \includegraphics[width=1\linewidth]{./lab3/PCA/single_three/PC4.png}
      \caption{}
      \label{fig:underfit}
    \end{subfigure}
    \begin{subfigure}[t]{0.19\linewidth}
      \includegraphics[width=1\linewidth]{./lab3/PCA/single_three/PC16.png}
      \caption{}
      \label{fig:underfit}
    \end{subfigure}
    \begin{subfigure}[t]{0.19\linewidth}
      \includegraphics[width=1\linewidth]{./lab3/PCA/single_three/PC50.png}
      \caption{}
      \label{fig:underfit}
    \end{subfigure}
    \begin{subfigure}[t]{0.19\linewidth}
      \includegraphics[width=1\linewidth]{./lab3/PCA/single_three/PC64.png}
      \caption{}
      \label{fig:underfit}
    \end{subfigure}
    \begin{subfigure}[t]{0.19\linewidth}
      \includegraphics[width=1\linewidth]{./lab3/PCA/single_three/PC128.png}
      \caption{}
      \label{fig:underfit}
    \end{subfigure}
    \begin{subfigure}[t]{0.19\linewidth}
      \includegraphics[width=1\linewidth]{./lab3/PCA/single_three/PC256.png}
      \caption{}
      \label{fig:underfit}
    \end{subfigure}
    \caption{}
  ...
  \begin{figure}[h]
    ...
    \end{subfigure}
    \begin{subfigure}[t]{0.3\linewidth}
      \includegraphics[width=1\linewidth]{./lab3/PCA/rec_vs_invsum_digits.png}
      \caption{Validation set avoids overfitting}
      \label{fig:perfect_fit}
    \end{subfigure}
    \begin{subfigure}[t]{0.3\linewidth}
      \includegraphics[width=1\linewidth, height=4cm]{./lab3/PCA/regression_digits.png}
      \caption{Overfit. 120 Neurons}
      \label{fig:overfit}
    \end{subfigure}
    \end{adjustwidth}
    \caption{hola hola hola hola hola hola hola hola hola hola hola hola hola hola hola hola hola
  ...
  \begin{figure}[h]
    ...
    \end{subfigure}
    \begin{subfigure}[t]{0.4\linewidth}
      \includegraphics[width=1\linewidth]{./lab3/PCA/regression_digits.png}
      \caption{Overfit. 120 Neurons}
      \label{fig:overfit}
    \end{subfigure}
    \begin{subfigure}[t]{0.4\linewidth}
      \includegraphics[width=1\linewidth]{./lab3/PCA/regression_gaussians.png}
      \caption{Overfit. 120 Neurons}
      \label{fig:overfit}
    \end{subfigure}
    \caption{hola hola hola hola hola hola hola hola hola hola hola hola hola hola hola hola hola
